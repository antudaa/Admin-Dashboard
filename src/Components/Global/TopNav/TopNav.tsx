...
import smallLogo from "@/Assets/OrganizationImages/shortlogo.png";
import DarkBackLogo from "@/Assets/OrganizationImages/DarkBackgroundLogo.png";
import WhiteBackLogo from "@/Assets/OrganizationImages/WhiteBackgroundLogo.png";
import Image from "next/image";

const TopNav = ({ toggle }: any) => {


    console.log(toggle)

    return (
        <nav className="top-0 z-50 border-x-slate-700  bg-[aliceblue] text-black w-full flex justify-between items-center mx-auto px-8 h-20">
            <div className="inline-flex">
                <a className="_o6689fn" href="/">
                    {/* Logo For Large Device  */}
                    <div className="hidden md:block">
                        <Image width="130" height="40" src={WhiteBackLogo} alt="Logo Image not found" />
                    ...
                    <div className="block md:hidden">
                        <Image width="30" height="30" src={smallLogo} alt="Logo Image not found" />
                    ...
                    <div className="flex mr-4 items-center">
                        ...
                        <div className="block relative">
                            <button type="button" className="inline-block py-2 px-3 rounded-full relative ">
                                <a className="relative inline-flex flex-shrink-0 justify-center items-center h-[2.375rem] w-[2.375rem] rounded-full border font-medium bg-transparent text-gray-700 shadow-sm align-middle focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all text-sm" href="#">
                    ...
                    <div className="block">
                        <div className="inline relative">
                            <button type="button" className="inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
                                <div className="pl-1 md:hidden" onClick={toggle}>
                                    <svg
                                        viewBox="0 0 32 32"
                                        xmlns="http://www.w3.org/2000/svg"
                                        aria-hidden="true"
